package com.arandastock001.EzLinearRegression.Gdrive;
...
import static com.arandastock001.EzLinearRegression.Gdrive.Ter.folderId;
...
public class GoogleDriveServiceHelper {
     ...
     */
    public Task<ArrayList<com.arandastock001.EzLinearRegression.Gdrive.GoogleDriveFileHolder>> getFolderFileList() {

        ArrayList<com.arandastock001.EzLinearRegression.Gdrive.GoogleDriveFileHolder> fileList = new ArrayList<>();
        ...
        return Tasks.call(mExecutor, () -> {
            ...
            for (int i = 0; i < result.getFiles().size(); i++) {
                com.arandastock001.EzLinearRegression.Gdrive.GoogleDriveFileHolder googleDriveFileHolder = new com.arandastock001.EzLinearRegression.Gdrive.GoogleDriveFileHolder();
